...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // index
        if ($pathinfo === '/index') {
            return array (  '_controller' => 'OneStopShop\\HomeBundle\\Controller\\IndexController::indexAction',  '_route' => 'index',);
        }
        ...
        if (0 === strpos($pathinfo, '/hello')) {
            ...
            // one_stop_shop_business_homepage
            if (preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // add_item
        if ($pathinfo === '/addItem') {
            return array (  '_controller' => 'OneStopShop\\ItemBundle\\Controller\\ItemController::addItemAction',  '_route' => 'add_item',);
        }

        // remove_item
        if ($pathinfo === '/removeItem') {
            return array (  '_controller' => 'OneStopShop\\ItemBundle\\Controller\\ItemController::removeItemAction',  '_route' => 'remove_item',);
        }
